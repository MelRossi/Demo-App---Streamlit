...
st.markdown("""
    ...
    <h1 class="gradient-text">Neuro Tx Latam</h1>
...
st.link_button(":page_facing_up: Descargar Archivo de Análisis", "https://github.com/MelRossi/Demo-App---Streamlit/blob/main/analisis%26modelos.pdf")
